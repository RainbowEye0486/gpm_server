...
{
  new (message_memory) gpm_interfaces::srv::Command_Request(_init);
}

void Command_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<gpm_interfaces::srv::Command_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Command_Request_message_member_array[2] = {
  {
    ...
    offsetof(gpm_interfaces::srv::Command_Request, action),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(gpm_interfaces::srv::Command_Request, destination),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Command_Request_message_members = {
  ...
  2,  // number of fields
  sizeof(gpm_interfaces::srv::Command_Request),
...
{
  return &::gpm_interfaces::srv::rosidl_typesupport_introspection_cpp::Command_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gpm_interfaces, srv, Command_Request)() {
  return &::gpm_interfaces::srv::rosidl_typesupport_introspection_cpp::Command_Request_message_type_support_handle;
}
...
void Command_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) gpm_interfaces::srv::Command_Response(_init);
}

void Command_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<gpm_interfaces::srv::Command_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Command_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(gpm_interfaces::srv::Command_Response, device),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(gpm_interfaces::srv::Command_Response, accept),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Command_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(gpm_interfaces::srv::Command_Response),
...
{
  return &::gpm_interfaces::srv::rosidl_typesupport_introspection_cpp::Command_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gpm_interfaces, srv, Command_Response)() {
  return &::gpm_interfaces::srv::rosidl_typesupport_introspection_cpp::Command_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers Command_service_members = {
  ...
  // see get_service_type_support_handle<gpm_interfaces::srv::Command>()
...
get_service_type_support_handle<gpm_interfaces::srv::Command>()
{
  ...
  auto service_type_support =
    &::gpm_interfaces::srv::rosidl_typesupport_introspection_cpp::Command_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gpm_interfaces, srv, Command)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<gpm_interfaces::srv::Command>();
}
