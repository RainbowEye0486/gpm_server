...
#ifndef GPM_INTERFACES__SRV__DETAIL__AMMR_REPORT__FUNCTIONS_H_
#define GPM_INTERFACES__SRV__DETAIL__AMMR_REPORT__FUNCTIONS_H_
...
/// Initialize srv/AmmrReport message.
/**
...
/// Finalize srv/AmmrReport message.
/**
...
/// Create srv/AmmrReport message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * gpm_interfaces__srv__AmmrReport_Request__init().
...
/// Destroy srv/AmmrReport message.
/**
 * It calls
 * gpm_interfaces__srv__AmmrReport_Request__fini()
...
/// Initialize array of srv/AmmrReport messages.
/**
...
/// Finalize array of srv/AmmrReport messages.
/**
 * It calls
 * gpm_interfaces__srv__AmmrReport_Request__fini()
...
/// Create array of srv/AmmrReport messages.
/**
 * It allocates the memory for the array and calls
 * gpm_interfaces__srv__AmmrReport_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/AmmrReport messages.
/**
 * It calls
 * gpm_interfaces__srv__AmmrReport_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * gpm_interfaces__srv__AmmrReport_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_gpm_interfaces
...
/**
 * It calls
 * gpm_interfaces__srv__AmmrReport_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_gpm_interfaces
...
/**
 * It allocates the memory for the array and calls
 * gpm_interfaces__srv__AmmrReport_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_gpm_interfaces
...
/**
 * It calls
 * gpm_interfaces__srv__AmmrReport_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // GPM_INTERFACES__SRV__DETAIL__AMMR_REPORT__FUNCTIONS_H_
