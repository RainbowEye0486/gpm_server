...
static const _Status_type_support_symbol_names_t _Status_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gpm_interfaces, msg, Status)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gpm_interfaces, msg, Status)),
  }
};
...
{
  return &::gpm_interfaces::msg::rosidl_typesupport_cpp::Status_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, gpm_interfaces, msg, Status)() {
  return get_message_type_support_handle<gpm_interfaces::msg::Status>();
}
