...
: ${AMENT_CURRENT_PREFIX:="/home/airobots/gpm_server/src/install/gpm_conveyer"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/gpm_conveyer/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/gpm_conveyer/environment/path.sh"
