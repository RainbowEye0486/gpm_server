...
bool gpm_interfaces__srv__command__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gpm_interfaces.srv._command.Command_Request", full_classname_dest, 43) == 0);
  }
  gpm_interfaces__srv__Command_Request * ros_message = _ros_message;
  {  // action
...
PyObject * gpm_interfaces__srv__command__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("gpm_interfaces.srv._command");
...
ROSIDL_GENERATOR_C_EXPORT
bool gpm_interfaces__srv__command__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gpm_interfaces.srv._command.Command_Response", full_classname_dest, 44) == 0);
  }
  gpm_interfaces__srv__Command_Response * ros_message = _ros_message;
  {  // device
